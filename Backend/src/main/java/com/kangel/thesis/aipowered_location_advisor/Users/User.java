...
public class User {
    ...
    //Legacy (alternatively use the same constructor but have the password be null on oauth2 but whatever)
    public User(String firstName, String lastName, String email, String username, String password, String pfp, String registration_method) {
    ...
    //OAuth2
    public User(String firstName, String lastName, String email, String username, String pfp, String registration_method) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        this.username = username;
